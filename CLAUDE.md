...
### 자체제작 주문 점검 (#madechk, 2026-09-03 사용자 요청 — 관리자+MD, 태그 지정은 관리자만)
...
- **제작처 태그 `made_products`**(product_no PK, origin cn/kr, lead_days 덮어쓰기 — db 프록시 읽기 admin+staff·쓰기 admin 커스텀 규칙). 리드타임 기본 **중국 10일 / 국내 9일(영업일 7일 환산)**.
